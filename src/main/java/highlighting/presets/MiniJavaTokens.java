...
public final class MiniJavaTokens {
    ...
    public static List<Token> defaultTokens() {
        return List.of(
            ...
            Token.of(Pattern.compile("\"([^\"\\\\]|\\\\.)*\""), ColorType.STRING_LITERAL_COLOUR),
            ...
            Token.of(
                Pattern.compile("\\b(?:public|private|protected)(?:\\s+(?:static|final|abstract|synchronized))*\\s+(?:void|[A-Z]\\w*)\\s+(\\w+)\\s*\\("),
                1,                                         // ← Gruppe 1 = der Methodenname
                ColorType.METHOD_NAME_COLOUR
            ),
            Token.of(
                Pattern.compile("(?<=\\.)\\w+(?=\\s*\\()"),
                ColorType.METHOD_CALL_COLOUR
            ),
            Token.of(
            ...
            Token.of(Pattern.compile("\\b[A-Za-z_][A-Za-z0-9_]*\\b"), ColorType.IDENTIFIER_COLOUR),
